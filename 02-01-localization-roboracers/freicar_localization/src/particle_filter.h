...
public:
    ...
    particle_filter(freicar::map::Map* map, std::shared_ptr<ros_vis> vis, bool use_lane_reg, float spawnPose_x, float spawnPose_y, float spawnPose_z, float spawnHeading);
...
private:
    ...
    float init_x, init_y, init_z, init_heading = 0.0f;
